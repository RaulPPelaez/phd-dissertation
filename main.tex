...
\begin{frame}
  ...
  \centering
  Random distribution with $\sim 1$ particle per grid point
  \note{
    \begin{itemize}
    ...
    \item In particular, with as much particles are grid points.
...
\begin{frame}
  ...
  \note{
    \begin{itemize}
    \item Turns out this works amazingly.
    ...
    \item In this case simplicity beats complexity. Now, being a closed-sourced architecture I have no way of knowing what it is exactly, but I am pretty sure there is something going on with atomics in the GPU that makes them way less expensive than they should.
    \end{itemize}
  }
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    %\vspace*{-20pt}
    \small [Maxian, {\bf Raul P. Pelaez} et. al. J. Chem. Phys. 2021.]
  \end{center}
  \note<1>{
    \begin{itemize}

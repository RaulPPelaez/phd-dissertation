...
\centering \Large  The coexistence between a liquid and solid phase
  \begin{figure}
    ...
    \movie[autostart,loop,poster,showcontrols=true,width=0.3\linewidth]{\includegraphics[width=0.3\linewidth]{rots.png}}{gfx/rots.mp4}\includegraphics[width=0.3\linewidth]{q2Dcolorstripe}\\
    {\fontsize{4.5}{12} \selectfont [Courtesy of Pablo Ibañez] ------------ [Courtesy of Berta Tinao] -------------- [{\bf Raul P. Pelaez} et al. JSTAT 2018.]}
%    \includesvg[width=0.49\linewidth]{gfx/q2d}
  \end{figure}
\end{frame}
...
\begin{frame} 
  ...
  \centering Example: Lennard-Jones potential, $r_c=2.5\sigma$
  $$U_{LJ}(r) = 
  \begin{cases}
...
\subsection{The challenges of a GPU complex fluid software}
\begin{frame}
  \frametitle{The challenges of a GPU complex fluid software}
\end{frame}
